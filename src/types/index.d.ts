export namespace FFmpeg {
  // Original From https://github.com/ffmpegwasm/ffmpeg.wasm/blob/master/src/index.d.ts
  // Edited by Friendseeker for browser environment
  export const FS: {
   ...
   *
   */
  export function fetchFile (data: string | Blob | File): Promise<Uint8Array>;
}